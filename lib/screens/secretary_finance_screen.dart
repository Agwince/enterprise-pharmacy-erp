...
class _SecretaryFinanceScreenState extends State<SecretaryFinanceScreen> {
  ...
  Widget build(BuildContext context) {
    return GradientScaffold(
      appBar: AppBar(
        title: Text('Secretary Finance & HR', style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: Colors.white)),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text('Status: ${entry['status']}', style: GoogleFonts.inter(color: Colors.white54)),
